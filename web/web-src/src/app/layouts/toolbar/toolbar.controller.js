(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController($cookieStore, $http, $injector, $rootScope, $mdMedia, $filter, $mdUtil, $mdSidenav, $mdToast,
                                      $document, triBreadcrumbsService, triSettings, triLayout,
                                      $state, PermissionService, triMenu, homeService) {
        ...
        if($injector.has('PermissionService')) {
            ...
            // permissions are turned off so no PermissionService available
        ...
        function logout() {
        		homeService.postToServer('../logout', {}).finally(function() {
                $rootScope.authenticated = false;
                triMenu.removeAllMenu();
                
                $cookieStore.remove('billingsystem.displayName');
                $cookieStore.remove('billingsystem.userName');
